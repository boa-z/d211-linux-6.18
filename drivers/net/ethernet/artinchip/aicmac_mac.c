...
static void aicmac_mac_config(struct phylink_config *config,
			      unsigned int mode,
			      const struct phylink_link_state *state)
{
	/* RMII/RGMII with an external PHY: the port setup is static, the
	 * speed/duplex programming happens in aicmac_mac_link_up().
	 */
}
